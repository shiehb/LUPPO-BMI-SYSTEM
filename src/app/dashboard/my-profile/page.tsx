      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {pending ? (
          ...
          <Button asChild className="gap-2 shrink-0 bg-orange-600 hover:bg-orange-700">
            <Link href={`/dashboard/my-profile/${revision.id}/edit`}>
          ...
          <Button asChild className="gap-2 shrink-0 bg-red-600 hover:bg-red-700">
            <Link href={`/dashboard/my-profile/${returned.id}/edit`}>
              <AlertTriangle className="size-4" />
              Edit & Resubmit
            </Link>
          </Button>
            ...
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
              ...
              {submissionWindowNotStarted ? (
                ...
                <Button asChild className="mt-4 gap-2">
                  <Link href="/dashboard/my-profile/new">
                    <Plus className="size-4" />
                    Create First Assessment
                  </Link>
                </Button>
                          ...
                          {(a.status === "draft" || a.status === "revision_required" || a.status === "returned") && (
                            <>
                              <Button asChild size="sm" variant="outline" className="h-7 px-2 text-xs">
                                <Link href={`/dashboard/my-profile/${a.id}/edit`}>Edit</Link>
                              </Button>
                              {isAssessmentComplete(a) && (
                                <Button asChild size="sm" className="h-7 px-2 text-xs">
                                  <Link href={`/dashboard/my-profile/${a.id}/review`}>Submit</Link>
                                </Button>
                              )}
                            </>
                          )}
